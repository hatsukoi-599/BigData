...
dataset = spark.read.text("/Users/shweta/Documents/COEN242-BigData/Assignment3/Part1/dataset/data_300MB.txt")
...
filtered_words = exploded_words.filter(~exploded_words.word.isin(stopwords) & (length(exploded_words.word) > 6))
...
output_file_path = "/Users/shweta/Documents/COEN242-BigData/Assignment3/Part1/Output/300MB/2"
